...
function Layout({ children }: { children: React.ReactNode }) {
  return (
    <div className="flex flex-col min-h-screen remix-app">
      {/* <header className="py-4 border-b">
        <div className="flex items-center justify-between max-w-5xl px-6 m-auto lg:px-0">
          <Link to="/" title="Remix" className="w-[106px] h-[30px]">
            <RemixLogo />
          </Link>
      ...
      <div className="flex flex-grow flex-shrink basis-full">
        <div className="w-full m-auto">{children}</div>
      </div>
      <footer className="py-20">
        <div className="w-full px-6 m-auto lg:px-0">
          <p>&copy; You!</p>
        </div>
      </footer>
    </div>
